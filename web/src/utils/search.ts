...
/**
 * Case-insensitive substring search over a person's given names (primary + additional),
 * family name and birth name. Prefix matches (a field starting with the query) rank before
 * other substring matches; ties break alphabetically by full name. Returns at most `limit` persons.
 */
